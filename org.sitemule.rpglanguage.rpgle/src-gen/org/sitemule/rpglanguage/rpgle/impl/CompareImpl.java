 ...
 * </p>
 * <ul>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getSpec <em>Spec</em>}</li>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getIntval2 <em>Intval2</em>}</li>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getStrval2 <em>Strval2</em>}</li>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getVar2 <em>Var2</em>}</li>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getBif2 <em>Bif2</em>}</li>
 *   <li>{@link org.sitemule.rpglanguage.rpgle.impl.CompareImpl#getCmp <em>Cmp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompareImpl extends BoolExprImpl implements Compare
{
  /**
  ...
  {
    return RpglePackage.Literals.COMPARE;
  }
  ...
  public void setSpec(String newSpec)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__SPEC, oldSpec, spec));
  }
  ...
  public void setIntval2(int newIntval2)
  {
    ...
    intval2 = newIntval2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__INTVAL2, oldIntval2, intval2));
  }
  ...
  public void setStrval2(String newStrval2)
  {
    ...
    strval2 = newStrval2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__STRVAL2, oldStrval2, strval2));
  }
  ...
  public Dcls getVar2()
  {
    if (var2 != null && var2.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RpglePackage.COMPARE__VAR2, oldVar2, var2));
      }
    }
    return var2;
  }
  ...
  public void setVar2(Dcls newVar2)
  {
    ...
    var2 = newVar2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__VAR2, oldVar2, var2));
  }
  ...
  public NotificationChain basicSetBif2(Bif newBif2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__BIF2, oldBif2, newBif2);
  ...
  public void setBif2(Bif newBif2)
  {
    if (newBif2 != bif2)
    {
      ...
      if (bif2 != null)
        msgs = ((InternalEObject)bif2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RpglePackage.COMPARE__BIF2, null, msgs);
      if (newBif2 != null)
        msgs = ((InternalEObject)newBif2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RpglePackage.COMPARE__BIF2, null, msgs);
      msgs = basicSetBif2(newBif2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__BIF2, newBif2, newBif2));
  }
  ...
  public NotificationChain basicSetCmp(Compare2 newCmp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__CMP, oldCmp, newCmp);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCmp(Compare2 newCmp)
  {
    if (newCmp != cmp)
    {
      NotificationChain msgs = null;
      if (cmp != null)
        msgs = ((InternalEObject)cmp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RpglePackage.COMPARE__CMP, null, msgs);
      if (newCmp != null)
        msgs = ((InternalEObject)newCmp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RpglePackage.COMPARE__CMP, null, msgs);
      msgs = basicSetCmp(newCmp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpglePackage.COMPARE__CMP, newCmp, newCmp));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RpglePackage.COMPARE__BIF2:
        return basicSetBif2(null, msgs);
      case RpglePackage.COMPARE__CMP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RpglePackage.COMPARE__SPEC:
        return getSpec();
      case RpglePackage.COMPARE__INTVAL2:
        return getIntval2();
      case RpglePackage.COMPARE__STRVAL2:
        return getStrval2();
      case RpglePackage.COMPARE__VAR2:
